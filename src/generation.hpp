...
public:
    ...
    void gen_term(const NodeTerm* term)
    {
        struct TermVisitor {
            ...
            {
                std::cout<< "    mov rax, " << term_int_lit->int_lit.value.value() << "\n";
                gen.m_output << "    mov rax, " << term_int_lit->int_lit.value.value() << "\n";
                gen.push("rax");
                std::cout<<("pushing rax into stack")<<"\n";
            ...
            void operator()(const NodeTermIdent* term_ident) const
            {
                const auto it = std::ranges::find_if(std::as_const(gen.m_vars), [&](const Var& var) {
                    std::cout<<"Assigning Value "<<var.name<<" : "<<term_ident->ident.value.value()<<"\n";
    ...
    void gen_bin_expr(const NodeBinExpr* bin_expr)
    {
        struct BinExprVisitor {
            ...
            void operator()(const NodeBinExprSub* sub) const
            {
                ...
                gen.pop("rax");
                gen.pop("rbx");
                std::cout<<"    rax,"<<sub->rhs<<"\n";
                std::cout<<"    rbx,"<<sub->lhs<<"\n";
            ...
            void operator()(const NodeBinExprAdd* add) const
            {
                ...
                gen.pop("rax");
                gen.pop("rbx");
                std::cout<<"    rax,"<<add->rhs<<"\n";
                std::cout<<"    rbx,"<<add->lhs<<"\n";
            ...
            void operator()(const NodeBinExprMulti* multi) const
            {
                ...
                gen.pop("rax");
                gen.pop("rbx");
                std::cout<<"    rax,"<<multi->rhs<<"\n";
                std::cout<<"    rbx,"<<multi->lhs<<"\n";
                gen.m_output << "    mul rbx\n";
                std::cout << "    mul rbx\n";
                gen.push("rax");
                std::cout<<"pushing rax in stack";
            }
            ...
            void operator()(const NodeBinExprDiv* div) const
            {
                ...
                gen.pop("rax");
                gen.pop("rbx");
                std::cout<<"    rax,"<<div->rhs<<"\n";
                std::cout<<"    rbx,"<<div->lhs<<"\n";
